...
import { useEndedEvents } from "@/app/event/(hook)/query/useEndedEvents";

export default function EndedEventsPage() {
  useHeader({ title: "종료된 행사", showBack: true, showMenu: false });

  const { data: events = [], isLoading, error } = useEndedEvents();
